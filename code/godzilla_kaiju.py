...
def rodan_gifs():
    ...
    with st.container(border=True):
        max_image = 6
        base_path = 'https://raw.githubusercontent.com/Adam-Mathew-Duke/godzilla_kaiju/6e01282ea6e7d8d6381d7d889b362b33fd76f08f/data/image_files/rodan_images/1.gif?raw=true'
